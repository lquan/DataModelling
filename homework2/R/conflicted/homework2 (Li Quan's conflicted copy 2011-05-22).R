...
#PCR
autosNum.pcr <- lm(autosNum$price~autosNum.pca$x[,1]+autosNum.pca$x[,2]+autosNum.pca$x[,3]+autosNum.pca$x[,4])
...
#PCR With Box-Cox
shapiro.test(autosNum$price)
boxcox(autosNum$price~autosNum.pca$x[,1]+autosNum.pca$x[,2]+autosNum.pca$x[,3]+autosNum.pca$x[,4])
lambda <- -0.4
...
autosNum.lm2 <- lm(formula, autosNum)
plot(autosNum.lm2)
